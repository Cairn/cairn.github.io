export function initStackVisualizer(canvas: HTMLCanvasElement) {
  ...
  function initNodes() {
    nodes = [
      // Models
      { id: 'claude', label: 'Claude', x: width * 0.15, y: height * 0.25, size: 28, color: '#f472b6', pulse: 0, pulseSpeed: 0.02, category: 'model' },
      { id: 'gemini', label: 'Gemini', x: width * 0.15, y: height * 0.5, size: 28, color: '#60a5fa', pulse: Math.PI / 3, pulseSpeed: 0.02, category: 'model' },
      { id: 'gpt4', label: 'GPT', x: width * 0.15, y: height * 0.75, size: 28, color: '#10b981', pulse: Math.PI * 2 / 3, pulseSpeed: 0.02, category: 'model' },
